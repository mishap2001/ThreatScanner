...
#ThreatScore – Build-Oriented Project Summary

#========================================
#1) PROJECT GOAL
#========================================

#Build a Bash-based threat intelligence enrichment and risk-scoring CLI that:
#- checks observables against multiple online sources
#- calculates a final score
#- assigns a severity
#- shows what each source returned
#- exports results as TXT / HTML / PDF
#========================================
#2) FINAL USER FLOW
#========================================
...
#Show menu
#↓
#User selects observable type
#↓
#Validate input
#↓
#Query relevant available sources
#↓
#Normalize findings
#↓
#Calculate score
...
#========================================
#4) STEP 1 – BUILD THE DEPENDENCY SCRIPT
#========================================
...
#- optionally create the config file template
#- optionally create reports/ directory
...
#2. check each required tool
#3. install missing tools
#4. print installation/check summary
#5. optionally prepare the project environment

#Expected outcome:
#The system is ready to run the main script.

#========================================
#5) STEP 2 – BUILD THE CONFIG AND API-KEY LOADING
#========================================
...
#1. check whether config file exists
#2. load it
#3. check each key variable
#4. print missing keys
#5. continue using only sources with available keys

#Design rule:
#Do not stop completely if some keys are missing.

#Expected outcome:
#The script knows which providers can be used.

#========================================
#6) STEP 3 – BUILD THE MAIN MENU
#========================================
...
#Why this order:
#- starts with infrastructure/web observables
#- ends with artifact observables

#Expected outcome:
#User can choose what type of observable to check.

#========================================
#7) STEP 4 – BUILD INPUT VALIDATION
#========================================

#Before any lookup, the script must validate user input.

#Validation required per option:
...
#Hash:
#- identify whether it is MD5, SHA-1, or SHA-256

#File:
#- file exists
#- file is readable
#- optionally detect basic file type

#Expected outcome:
#Only valid input reaches the lookup stage.

#========================================
#8) STEP 5 – BUILD THE OBSERVABLE CHECK LOGIC
#========================================

#At this stage, each menu option gets its own logic:
...
#- owner / organization
#- location / country
#- registration / ownership context
...
#What the script checks:
#- domain reputation
#- community intel hits
#- historical scan presence
#- registration / ownership context

#Data to extract:
#- VT results
#- OTX hits/pulses
#- urlscan history/presence
#- registrar / ownership / registration context
...
#What the script checks:
#- URL reputation
#- malicious URL database hits
#- scan/page history
#- community intel

#Data to extract:
#- VT malicious/suspicious results
#- URLhaus hit/no hit
#- urlscan presence / scan details
#- OTX hits if available
...
#What the script checks:
#- known malicious sample presence
#- malware family / tags
#- community intel hits
...
#- known malware sample info
#- intel enrichment

#Optional behavior:
#- if the file hash is unknown and upload behavior is enabled, upload the file to VirusTotal

#Data to extract:
#- file name
#- hashes
#- VT detections
#- MalwareBazaar family / tags
#- OTX hits if present

#Expected outcome:
#Each observable type can be checked against its relevant sources.

#========================================
#9) STEP 6 – BUILD GRACEFUL SOURCE HANDLING
#========================================

#The script must handle missing providers correctly.

#Rules:
#- only use relevant sources for the selected observable
#- skip sources whose keys are missing
#- do not fail the whole check because one source is unavailable
#- show which sources were skipped

#Examples:
#- if OTX key is missing, skip OTX
#- if MalwareBazaar key is missing, File and Hash checks still continue
#- if only one source is available, still produce a result

#Expected outcome:
#The tool works even with partial API-key coverage.

#========================================
#10) STEP 7 – BUILD RESULT NORMALIZATION
#========================================

#Before scoring or exporting, all findings should be normalized into one internal result structure.
...
#Design rule:
#TXT, HTML, and PDF must all be generated from the same normalized result.

#Expected outcome:
#The script has one clean internal format for results.

#========================================
#11) STEP 8 – BUILD THE SCORING SYSTEM
#========================================

#The script will not explain the verdict in natural language.
#It will:
#- assign points based on source findings
#- calculate a final score
#- map that score to severity
...
#User-visible result should include:
#- final score
#- severity
#- what each source said

#Expected outcome:
#Every observable check produces a consistent, readable result.

#========================================
#12) STEP 9 – BUILD SCREEN OUTPUT
#========================================

#After scoring, the script should print the result to screen.
...
#Expected outcome:
#The user gets an immediate readable result in the terminal.

#========================================
#13) STEP 10 – BUILD EXPORT OPTIONS
#========================================

#After displaying the result, the script should let the user choose export format.
...
#Suggested flow:
#1. print result to screen
#2. ask user which output format they want
#3. save report into reports/

#Expected outcome:
#The same result can be saved in different formats.

#========================================
#14) STEP 11 – BUILD REPORT GENERATION
#========================================

#The report engine should generate files from the normalized result structure.

#TXT report:
#- plain text summary

#HTML report:
#- structured readable report in browser

#PDF report:
#- generated from the same result data
#- ideally through HTML-to-PDF flow or another clean export method

#Suggested report naming:
#reports/<type>_<value>_<timestamp>.<ext>

#Expected outcome:
#Reports are saved in a consistent and organized way.

#========================================
#15) FINAL SOURCE MAPPING
#========================================
...
#========================================
#16) FINAL TECHNICAL BEHAVIOR SUMMARY
#========================================
...
#- skip missing/unavailable sources
...
#- assign severity
#- display findings
#- export reports as TXT / HTML / PDF
...
#2. config file template
#3. API-key loading/checking in threatscore.sh
#4. main menu
#5. input validation
#6. observable lookup functions
#7. result normalization
#8. scoring logic
#9. screen output
#10. export system
#11. TXT / HTML / PDF generation
